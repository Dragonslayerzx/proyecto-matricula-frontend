    ...
    <section class="d-flex mb-3">
      <form action="{{ route('expediente.mandar') }}" method="post" class="d-flex flex-column justify-content-around p-8 form">
        ...
        <div class="d-flex flex-column justify-content-center">
          ...
          <input class="form-control mb-4" type="text" id="nombre" name="nombreCarrera" placeholder="Nombre de carrera">
          <label class="form-label" for="coordinador">Selecciona el coordinador</label>
