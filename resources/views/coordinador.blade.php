    ...
    <div class="col">
      <div class="card text-center">
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <h5 class="card-title mt-5">¡Bienvenido Coordinador!</h5>
              <p class="card-text mt-4">Sistema de gestión de matrícula</p>
            </div>  
            <div class="col-md-6">
              <div class="card-img">
                <img src="{{ asset('img/cordiHome.svg') }}" alt="docenteHome" class="img-fluid py-3"  width="250px">
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="col-md-4">
      <div class="card">
        <div class="card-body text-center">
          <h5 class="card-title mt-3">Planificacion Académica</h5>
          <p class="card-text mt-3">Ver, crear y modificar secciones</p>
          <a href="{{ route('coordinador.planificacion') }}" class="btn btn-primary mt-3">Ir a PA</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
